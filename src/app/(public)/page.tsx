    ...
    <div className="w-full">
      ...
      <section className="relative w-full py-20 md:py-32 bg-[#7C3AED] overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Link href="/events">
            <Button size="lg" className="bg-[#7C3AED] text-white hover:opacity-90 shadow-xl text-lg px-8 py-6 rounded-full transition-all hover:scale-105 border border-white/20">
              Jelajahi Event
            </Button>
          </Link>
        </div>
